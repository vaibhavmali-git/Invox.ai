      ...
      <div className='flex items-center justify-center min-h-screen px-4 text-center'>
        ...
        <div className='bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all'>
          <div className='flex items-center justify-between mb-4'>
            <h3 className='text-lg font-semibold text-slate-900 flex items-center'><Sparkles className='w-5 h-5 text-blue-600 mr-2'/> Create Invoice with AI</h3>
          ...
          <div className='flex justify-end space-x-3 mt-6'>
            ...
            <Button onClick={handleGenerate} isLoading={isLoading}>{isLoading ? "Generating...":"Generate Invoice"}</Button>
          </div>
        </div>
      </div>
    </div>
